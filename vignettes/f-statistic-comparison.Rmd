...
if (requireNamespace("ivreg", quietly = TRUE)) library(ivreg)
if (requireNamespace("lfe", quietly = TRUE)) library(lfe)
library(OneSampleMR)
```
...
if (requireNamespace("haven", quietly = TRUE)) {
  ...
  if (requireNamespace("ivreg", quietly = TRUE)) {
    ...
    print("The ivreg package is not available, so this example was not run")
  }
} else {
  print("The haven package is not available, so this example was not run")
}
```
...
if (requireNamespace("lfe", quietly = TRUE)) {
  ...
  print("The lfe package is not available, so this example was not run")
}
```
